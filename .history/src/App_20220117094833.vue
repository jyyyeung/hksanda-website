 ...
 * @LastEditors: YYYeung
 * @LastEditTime: 2022-01-17 09:48:09
...
export default {
  ...
  mounted() {
    // TODO: try detecting html lang to check and refresh to the correct language maybe check vue i18n package if useful and simple?
    this.$nextTick(() => {
      this.localizePage();
    });
    // console.log(this);
