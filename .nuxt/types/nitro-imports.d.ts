declare global {
  const __buildAssetsURL: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nuxt/dist/core/runtime/nitro/paths"))["buildAssetsURL"];
  const __publicAssetsURL: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nuxt/dist/core/runtime/nitro/paths"))["publicAssetsURL"];
  ...
  const cachedEventHandler: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["cachedEventHandler"];
  const cachedFunction: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["cachedFunction"];
  ...
  const defineAppConfig: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nuxt/dist/core/runtime/nitro/config"))["defineAppConfig"];
  const defineCachedEventHandler: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["defineCachedEventHandler"];
  const defineCachedFunction: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["defineCachedFunction"];
  const defineEventHandler: (typeof import("h3"))["defineEventHandler"];
  const defineLazyEventHandler: (typeof import("h3"))["defineLazyEventHandler"];
  const defineNitroPlugin: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["defineNitroPlugin"];
  ...
  const defineRenderHandler: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["defineRenderHandler"];
  ...
  const getRouteRules: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["getRouteRules"];
  ...
  const groq: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/@nuxtjs/sanity/dist/runtime/groq"))["groq"];
  ...
  const nitroPlugin: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["nitroPlugin"];
  ...
  const useAppConfig: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["useAppConfig"];
  const useBase: (typeof import("h3"))["useBase"];
  const useNitroApp: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["useNitroApp"];
  const useRuntimeConfig: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["useRuntimeConfig"];
  const useSanity: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/@nuxtjs/sanity/dist/runtime/nitro-imports"))["useSanity"];
  const useSession: (typeof import("h3"))["useSession"];
  const useStorage: (typeof import("/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime"))["useStorage"];
  const writeEarlyHints: (typeof import("h3"))["writeEarlyHints"];
}
export { createClient as createSanityClient } from "#sanity-client";
export { useSanity } from "../../node_modules/@nuxtjs/sanity/dist/runtime/nitro-imports";
...
export {
  ...
  getRouteRules,
  useAppConfig,
} from "/Users/jyyyeung/Projects/hksanda-website/node_modules/nitropack/dist/runtime";
export {
  appendCorsHeaders,
