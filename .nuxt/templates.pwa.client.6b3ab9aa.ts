...
// @ts-ignore
const options: { periodicSyncForUpdates: number; installPrompt?: string } = {
...
export default defineNuxtPlugin(() => {
  ...
  const hideInstall = ref(
    !options.installPrompt
      ? true
      : localStorage.getItem(options.installPrompt) === "true",
  );
