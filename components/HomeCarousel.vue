    ...
    <section class="col-12">
        <div class="slider-home">
            <div v-if="getCarouselById" id="homeCarousel" ref="homeCarousel"
                ...
                <button class="carousel-control-prev d-none d-md-block" data-bs-slide="prev" data-bs-target="#homeCarousel"
                    type="button">
                    <span aria-hidden="true" class="carousel-control-prev-icon" />
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next d-none d-md-block" data-bs-slide="next" data-bs-target="#homeCarousel"
                    type="button">
