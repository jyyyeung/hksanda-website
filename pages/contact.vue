<template>
  <div class="container min-h-[60vh]">
    ...
    <div class="grid grid-cols-12 content-center">
      ...
      <div
        class="col-span-12 m-auto hidden h-full w-full md:col-span-6 md:block"
      >
        <ClientOnly>
          <iframe
            class="h-full w-full overflow-hidden border-none"
            id="facebook-frame"
      ...
      <form class="w-full">
        <div class="-mx-3 mb-6 flex flex-wrap">
          ...
          <div class="mb-6 w-full px-3 md:mb-0 md:w-1/2">
            ...
            <select
              id="course"
              class="block w-full rounded-lg p-2.5 focus:border-primary focus:ring-primary"
              v-model="course"
            >
        ...
        <div class="md:flex md:items-center">
          <div class="md:w-1/3">
            <button :class="`btn-primary `" type="button">
              <a
                v-bind:href="`https://wa.me/85297322082?text=${encodeURI(
                  `稱呼: ${name} \n查詢課程: ${course} \n查詢內容: ${message}`
                )}`"
                target="_blank"
                class="no-highlight"
