<template>
  <section>
    <h1>最新資訊</h1>
    <div v-for="post in posts" :key="post._id" class="my-2 inline-block w-full shadow-primary hover:shadow-2xl">
      <NuxtLink :href="`/news/post-${post._id}`" class="no-highlight">
        <div class="rounded-lg border-4 border-primary p-6 shadow md:flex">
          ...
          <div class="my-auto ml-auto w-fit">
            ...
            <svg class="animate-bounce-h h-12 w-12 rounded-lg fill-primary stroke-primary stroke-2"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path fill="#888888" d="m14 18l-1.4-1.45L16.15 13H4v-2h12.15L12.6 7.45L14 6l6 6l-6 6Z" />
            </svg>
          </div>
        </div>
      </NuxtLink>
